...
**日本**：[第Ⅰ部A-6](meiji-centralization)で記述したとおり、1872年に学制が公布されました。1886年の小学校令により、義務教育の期間が定められます。就学率は、1900年代に90%を超えました [ [ 195 ] ](https://www.mext.go.jp/b_menu/hakusho/html/others/detail/1317552.htm) 。
...
```mermaid
flowchart TD
    subgraph G[19世紀の3つの要請]
        direction TB
        R1[要請1. 国民国家の形成<br>共通の言語と帰属意識<br>主要因とされる] ~~~ R2[要請2. 産業労働力<br>定時集合 手順の遵守<br>主要因とは認められず]
        R2 ~~~ R3[要請3. 軍事的な要請<br>敗戦を契機とする改革<br>命令の理解と規律]
    end
    G -->|均質な内容を<br>限られた費用で| S[共通する設計<br>年齢別の編成 時間割<br>課程の標準化 修了認定]
    S --> E[効果4. 制度の層<br>最も変化が遅い<br>要請が変わっても残る]
...
この図は、上段の枠で縦に並べた3つの要請が、中段の1つの設計へ合流する形をしています。枠内の3つの箱は並列の項目で、上下の位置は重要度の順ではありません。

枠内の各箱の3行目には、ラミレスとボリの分析における位置づけを記しました。要請1の国民国家の形成が主要因とされ、要請2の産業労働力は主要因とは認められていません。要請3は、敗戦後のプロイセンとフランスの改革を国家間の競争として位置づけたものです。

枠から中段へ向かう矢印に添えた語が、3つの要請に共通する制約です。年齢による編成、時間による区分、そして課程の標準化は、いずれも教育学的な最適性から導かれたものではありません。多数の対象へ均質な内容を、限られた費用で供給するという要請から導かれました。

[第Ⅰ部A-6](meiji-centralization)で記述したとおり、明治期の中央集権化において、学制は4つの機能の集約の1つでした。人事、財政、武力、そして人材規格です。教育制度は、この第四の機能を担いました。

ここで重要なのは、中段の設計が当時の条件下では有効に機能したという点です。識字率の向上、平均的な学力の底上げ、そして出身にかかわらず一定の教育を受ける機会の提供は、いずれもこの制度によって実現されました。

最下段の箱は、この設計が[第Ⅰ部C-1](innovation-overview)で整理した4段階モデルのどこに位置するかを示します。教育制度は効果4、すなわち制度の変更にあたります。効果4は最も変化が遅い層であるため、上段の要請が変わっても設計は残り続けます。
...
3.  **現代社会の現状と課題**
    ...
    [第Ⅲ部-4](risk-ai-and-dependency)で述べるとおり、生成AIの導入は、技能の習得過程に影響しうることが観測されています。初級の作業を反復することによって技能を習得する経路が変化する場合、教育制度が前提としてきた学習の順序も再検討の対象になります。

    ただし、[第Ⅰ部C-1](innovation-overview)で整理したとおり、効果4は最も変化が遅い層です。したがって、産業側の変化と教育制度の変化との間には、相当の時間差が生じます。

    [第Ⅲ部](future-method)で提示する3つのシナリオにおいて、この時間差の長さは重要な分岐要素です。楽観シナリオは、この時間差が短縮される場合に該当します。
