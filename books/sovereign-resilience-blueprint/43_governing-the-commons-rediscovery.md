...
本章は、[第Ⅴ部-3](44_ostrom-principles-1-4-engineering)および第Ⅴ部-3で扱う設計原則の基礎です。また、[第Ⅳ部-2](implication-community)で参照した研究の詳細にあたります。
...
これらは、[第Ⅴ部-3](44_ostrom-principles-1-4-engineering)および第Ⅴ部-3で個別に扱います。
...
本書にとって重要なのは、右の枠の中で選択肢3の下に条件の箱が付いている点です。8つの設計原則のいずれかが欠ければ、自主管理は持続しません。[第Ⅰ部D-6](08_american-frontier-self-reliance)で記述したアメリカ開拓期の鉱山規約が機能したのは、集団の規模が限定され、監視と制裁が実効的であった場合に限られていました。

[第Ⅳ部-2](implication-community)で述べたとおり、地域社会に期待される機能が供給の共同維持へ拡張される場合、必要となるのはこの8つの設計原則です。災害直後の相互援助とは異なり、長期の共同管理は制度を要します。
...
1.  **現代社会構造の原点**
    ...
    現代の供給インフラは、選択肢1と選択肢2の組み合わせによって運営されています。上下水道は主として国家管理、電力と通信は規制のもとでの私企業です。選択肢3は、[第Ⅰ部C-7](06_electrification-dawn)で記述した経緯の中で、規模の経済に押されて周縁化されました。
...
3.  **現代社会の現状と課題**
    ...
    [第Ⅱ部A-4](39_fortressed-cities-vulnerable-wilderness)で記述したとおり、集約型インフラの維持範囲は縮小に向かっています。その外側において、選択肢3が実際の選択肢となる区域が生じます。

    [第Ⅴ部-3](44_ostrom-principles-1-4-engineering)以降で扱うのは、8つの設計原則を現代の技術で実装する方法です。とりわけ、監視と制裁と紛争解決に要する費用を、技術によってどこまで下げられるかが論点となります。
