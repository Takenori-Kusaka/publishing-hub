...
[第Ⅰ部B-3](capitalism-why-irreplaceable)で参照した分析においても、計画指標の達成が品質や需要適合より優先される傾向、および生産単位が自らの能力を過少に報告する動機が観測されています [ [ 84 ] ](https://www.aeaweb.org/articles?id=10.1257/jep.5.4.11) 。
...
観測された不具合は、右の列の下段に集中しています。ここで重要なのは、その原因が指導者の資質や意図に帰されていないという点です。コルナイの分析も、[第Ⅰ部B-3](capitalism-why-irreplaceable)で参照した分析も、原因を制度の誘因構造に求めています。
...
1.  **現代社会構造の原点**
    ...
    現代の先進国が備える社会保障制度、累進課税、労働時間規制、そして公教育の無償化は、その多くが19世紀の労働運動と社会主義運動が提起した課題への応答として制度化されました。たとえば1883年にドイツで成立した疾病保険法は、社会主義者を取り締まる法律のもとで労働者の支持を確保する目的を伴って導入されました [ [ 267 ] ](https://www.ssa.gov/history/ottob.html) 。一方、プロイセンの義務教育のように、社会主義運動に先行する制度も存在します。
...
3.  **現代社会の現状と課題**
    ...
    [第Ⅲ部](future-method)では、生成AIによる情報処理能力の向上が、経路2の制約をどの程度解除しうるかを検討します。
