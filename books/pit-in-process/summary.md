...
本書の作成には、生成AIの Claude（Anthropic の Claude Opus 5 と Claude Fable 5.1）を使いました。本文の作成と改稿、校正に使っています。著者が内容を確認し、必要に応じて修正しました。公開した内容の責任は著者が負います。
