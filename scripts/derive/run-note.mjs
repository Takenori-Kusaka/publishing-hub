...
const slots = [
  ...
  { id: 'switch', heading: '公開の前に、必ず私の操作を1つ置く', secs: ['7.1', '7.4'], intent: '公開のスイッチは媒体ごとに1つで、生成AIを含め誰が立ててもよい。変更は本流とは別の枝に置き、公開の処理が動くのは、自分が本流へ取り込んだ(マージした)ときか、自分が手で起動したとき。note は公開してよいという印が ready に変わった原稿だけが投稿される。一人称、平易な言葉で。3〜5 文。', min: 3 },
  { id: 'ai', heading: 'AIとの線引き', secs: ['7.1'], intent: '生成AIには公開の印を立てるところまで任せる。以前は、公開の手前に人の確認を重ねても公開は最後の門で止まるので、守りは増えず人の操作だけが増えている、と考えた（当時の理由）。そこで、確認の記録を本流への取り込み（マージ）の1つだけに残すと決めた。公開の前には、取り込みか手動の起動という人の操作が必ず入る。2〜4 文。', min: 2 },
