...
- **Keep the medium's name:** When a note jargon rule (N11) makes you paraphrase, keep the medium's name (for example Qiita の検査) instead of generalising to 他のメディア.
